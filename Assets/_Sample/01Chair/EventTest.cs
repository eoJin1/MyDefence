...
namespace Sample
{
...

    {
        ...
        {
            Debug.Log("[7-1] OnEnable 실행");  //1회 실행 - 활성화 할때마다
        }
        ...
        private void Update()
        {
            Debug.Log("[4] Update 실행");  //매 프레임마다 호출, 1초 60(300, 30)번 호출   //프로그램을 어떻게 짜느냐에 따라 달라짐
        }
        ...
        {
            Debug.Log("[7-2] OnDisable 실행");  //1회 실행 - 비활성화 할때마다
        }
