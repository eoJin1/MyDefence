...
namespace Sample
{
    ...
    public class ComponentTest : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            //[2] 
            //이동 목표 지점
            //targetPosition = new Vector3(7f, 1f, 8f); //이렇게 지정 안 해도 타겟의 위치값을 가져오면 됨
            //targetPosition = targetGameObject.transform.position;   //길어
            ...
            TargetTest tTest = targetGameObject.GetComponent<TargetTest>();
            tTest.a = 70;
...
[2] 하이라키 창에 존재하는 다른 오브젝트의 게임오브젝트(트랜스폼, 컴포넌트)의 인스턴스에 접근하는 방법
    public으로 객체 변수 선언하고 인스펙터 창에서 드래그로 가져온다 

컴포넌트()의 인스턴스를 가져오는 방법
